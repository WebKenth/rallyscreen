...
},{"_process":71}],75:[function(require,module,exports){
...
exports.default = {
    ...
    methods: {
        ...
        changeOrder: function changeOrder(order) {
            ...
            array.forEach(function (element, index, array) {
                ...
                if (is_m5) {
                    array_m5.push(element);
                } else if (is_m4) {
                    array_m4.push(element);
                } else if (is_m3) {
                    array_m3.push(element);
                } else if (is_m2) {
                    array_m2.push(element);
                } else if (is_m1) {
                    array_m1.push(element);
                } else {
                    array_m0.push(element);
                }
            });
        ...
        sortDrivers: function sortDrivers() {
            var vm = this;
            vm.changeOrder(1);
            vm.changeOrder(4);
        },
        getHeatData: function getHeatData(heat_id) {
            var vm = this;
            vm.$http.get('/api/livescore/' + heat_id).then(function (response) {
        ...
        initializeVehicles: function initializeVehicles() {
            var vm = this;
            var data = [];
            if (vm.heat.van_1) {
                var driver_data = {
            ...
            vm.$http.post('/api/livescore/bundleGetLiveVehicle', data).then(function (response) {
                ...
                result.forEach(function (element, index, array) {
                    ...
                    if (element.order == 6) {
                        vm.$set('truck_3', element.vehicle);
                    }
        ...
        setActiveDrivers: function setActiveDrivers(data) {
            ...
            this.$http.post('/api/livescore/getLiveVehicle/', data).then(function (response) {
                ...
                if (order == 1) {
                    vm.$set('van_1', result.vehicle);
                }
                if (order == 2) {
                    vm.$set('van_2', result.vehicle);
                }
                if (order == 3) {
                    vm.$set('van_3', result.vehicle);
                }
                if (order == 4) {
                    vm.$set('truck_1', result.vehicle);
                }
                if (order == 5) {
                    vm.$set('truck_2', result.vehicle);
                }
                if (order == 6) {
                    vm.$set('truck_3', result.vehicle);
                }
            });
        },
        ...
        startDriverLoop: function startDriverLoop(data) {
            ...
            if (data.order == 1) {
                diims_id = vm.$get('van_1.diims_id');
            }
            if (data.order == 2) {
                diims_id = vm.$get('van_2.diims_id');
            }
            if (data.order == 3) {
                diims_id = vm.$get('van_3.diims_id');
            }
            if (data.order == 4) {
                diims_id = vm.$get('truck_1.diims_id');
            }
            if (data.order == 5) {
                diims_id = vm.$get('truck_2.diims_id');
            }
            if (data.order == 6) {
                diims_id = vm.$get('truck_3.diims_id');
            }
                ...
                success: function success(data) {
                    ...
                    if (vehicle_is_started) {
                        ...
                        if (!driver.heat_stats.start_time) {
                            ...
                            vm.$http.post('/api/livescore/updateStartTime/', time_data).then(function (response) {
                    ...
                    if (vehicle_is_stopped) {
                        ...
                        if ((0, _typeof3.default)(vm.$get('timer_' + order + '.live_counter')) != undefined) {
        ...
        updateHeatStats: function updateHeatStats(order) {
            ...
            //            }else
            //            {
            //                data.kml = parseFloat(litres_of_fuel_used).toFixed(0);
            //            }
            ...
            if (time_passed > 300 && time_passed < 315) {
                ...
                data.milestone = 1;
                vm.$http.post('/api/livescore/updateMilestone', data).then(function (response) {});
            ...
            if (order == 6) {
                ...
                fuel_gauges[5].set(driver.heat_stats.fuel_used);
    ...
    ready: function ready() {
        ...
        target_fuel.push($('#truck_3_gauge_fuel')[0]);
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  if (!module.hot.data) {
    hotAPI.createRecord("_v-60fbfb16", module.exports)
  } else {
    hotAPI.update("_v-60fbfb16", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
},{"babel-runtime/core-js/json/stringify":1,"babel-runtime/helpers/typeof":4,"vue":74,"vue-hot-reload-api":72,"vueify/lib/insert-css":75}],77:[function(require,module,exports){
var __vueify_insert__ = require("vueify/lib/insert-css")
var __vueify_style__ = __vueify_insert__.insert("\n\n")
'use strict';
...
},{"vue":74,"vue-hot-reload-api":72,"vueify/lib/insert-css":75}],78:[function(require,module,exports){
'use strict';
...
},{"../components/livescore.vue":76,"../components/livescoreheat.vue":77,"vue":74,"vue-resource":73}]},{},[78]);
