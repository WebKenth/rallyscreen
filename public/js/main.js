...
exports.default = {
    ...
    computed: {},
    methods: {
        progressSecondsToPercent: function progressSecondsToPercent(driver) {
        ...
        timeSinceInHuman: function timeSinceInHuman(driver) {
            var vm = this;
            var start_time_in_seconds = driver.heat_stats.start_time;
            var stop_time_in_seconds = driver.heat_stats.stop_time;
        ...
        timeToHuman: function timeToHuman(time_in_seconds) {
        ...
        getHeatData: function getHeatData(heat_id) {
            ...
            vm.$http.post('/api/livescore/', data).then(function (response) {
        ...
        stopDriverLoop: function stopDriverLoop(data) {
            ...
            if (!driver.heat_stats.stop_time && driver.heat_stats.start_time) {
                ...
                $.ajax({
                    ...
                    crossDomain: true,
                    data: (0, _stringify2.default)({ DeviceId: vm.getVehicle(vehicle_id).diims_id }),
                    dataType: "json",
                        ...
                        if (driver.heat_stats.start_time) {
                            ...
                            if (driver.heat_stats.send_time && !vehicle_diims_data[0]) {
                                ...
                                $.ajax({
                                    ...
                                    contentType: "application/json; charset=utf-8",
                                    crossDomain: true,
                                    data: (0, _stringify2.default)({ DeviceId: diims_id, SendTime: driver.heat_stats.send_time }),
                                    dataType: "json",
                                    success: function success(response) {
        ...
        getVehicleDiimsData: function getVehicleDiimsData(order) {
            var vm = this;
            if (order == 1) {
                return vm.$get('van_1.diims_data');
            }
            if (order == 2) {
                return vm.$get('van_2.diims_data');
            }
            if (order == 3) {
                return vm.$get('van_3.diims_data');
            }
            if (order == 4) {
                return vm.$get('truck_1.diims_data');
            }
            if (order == 5) {
                return vm.$get('truck_2.diims_data');
            }
            if (order == 6) {
                return vm.$get('truck_3.diims_data');
            }
        },
        updateVehicleDiimsData: function updateVehicleDiimsData(order, diims_data, index) {
            var vm = this;
            var marker;
            if (order == 1) {
